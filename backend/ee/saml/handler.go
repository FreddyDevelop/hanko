...
import (
	...
	auditlog "github.com/FreddyDevelop/hanko/backend/v2/audit_log"
	"github.com/FreddyDevelop/hanko/backend/v2/ee/saml/dto"
	"github.com/FreddyDevelop/hanko/backend/v2/ee/saml/provider"
	samlUtils "github.com/FreddyDevelop/hanko/backend/v2/ee/saml/utils"
	"github.com/FreddyDevelop/hanko/backend/v2/persistence/models"
	"github.com/FreddyDevelop/hanko/backend/v2/session"
	"github.com/FreddyDevelop/hanko/backend/v2/thirdparty"
	"github.com/FreddyDevelop/hanko/backend/v2/utils"
	"net/http"
	"net/url"
	"strings"
	"time"
